...
class MarkerCameraHandler(CameraHandler):
    def __init__(self, camera_idx, angle_horizontal, angle_vertical):
        super(MarkerCameraHandler, self).__init__(camera_idx)
...
class PoseEstimatorService:
    def __init__(self):
        ...
        self.camera_handler = MarkerCameraHandler(0, self.view_angle[0], self.view_angle[1])
